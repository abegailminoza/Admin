<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ADMIN_DONORLIST.aspx.vb" Inherits="LifePoints_Admin.ADMIB_DONORLIST" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>LifePoints - Donor List</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark bg-danger bg-gradient align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(119,40,32);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="margin-top: 18px;padding-top: 42px;margin-bottom: 8px;padding-bottom: 11px;"><img src="assets/img/logotechysavor.png" width="74" height="65"><img style="background: url(&quot;assets/img/solologo.png&quot;);" width="65" height="61" src="assets/img/solologo.png">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="UserList.html"><i class="fas fa-table"></i><span>User List</span></a><a class="nav-link active" href="DonorList.html"><i class="fas fa-window-maximize"></i><span>Donor List</span></a><a class="nav-link" href="RequestList.html"><i class="fas fa-window-maximize"></i><span>Request List</span></a></li>
                    <li class="nav-item"></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="text-dark mb-4">&nbsp; &nbsp; Donor List</h3>
                <div class="container-fluid">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="padding-right: 0px;">Donor ID</th>
                                    <th>Last Name</th>
                                    <th>First Name</th>
                                    <th>Middle Name</th>
                                    <th>Status</th>
