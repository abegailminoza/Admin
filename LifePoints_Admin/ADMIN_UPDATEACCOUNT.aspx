<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ADMIN_UPDATEACCOUNT.aspx.vb" Inherits="LifePoints_Admin.ADMIN_UPDATEACCOUNT" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>LifePoints - Update Account</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Update Account</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Username</strong></label><input class="form-control" type="text" id="username" placeholder="Type username" name="username"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"></div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>New Password</strong><br></label></div><input class="form-control" type="password">
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Current Password</strong></label></div><input class="form-control" type="password">
                                                    </div>
                                                </div>
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" style="padding: 9px 8px;margin: 19px;background: rgb(119,40,32);">Update</button></div>
                                            </form>
                                        </div>
                                    </div>
